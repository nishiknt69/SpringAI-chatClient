...
public class FlightBookingTools {
    ...
    public BookingResponse createBooking(
            ...
            @ToolParam(description = "The description for the flight booking (e.g. city like Delhi, London etc")
            String destination,

            @ToolParam(description = "Departure date and time is ISO-8601 format (e.g., 2025-12-25T14:30:00Z")
